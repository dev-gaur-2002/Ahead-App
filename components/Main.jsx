            ...
            >
                ...
                >
                    <p className="font-semibold text-sm  text-[#53553]">
                        Let your friends, family, and co-workers rate your
                        skills.
                    </p>
                ...
                <div className="flex justify-center items-center">
                    <ul className="timeline mt-12 md:ml-40 ml-1" id="timeline">
                        ...
                        <li className="li">
                            ...
                            >
                                <h4 className="text-sm font-medium">
                                    Find out where you and others see things the
                ...
                >
                    <UI_Image
                        src="/assets/anotherway.png"
                        alt="anotherway image"
                        width={1000}
                        height={1000}
