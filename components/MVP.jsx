        ...
        <section className='md:px-4 flex md:mt-40 mt-28 font-[Montserrat]'>
            <motion.div
                    ...
                    <ul className="timeline mt-12 md:ml-40 ml-1" id="timeline">
                        <li className="li">
                            <motion.div
                                ...
                                viewport={{ once: true }}
                                className="timestamp ">
                                <Image src='/assets/symbolsun.png' alt='sun image' width={50} height={50} className='-mb-6' />
                ...
                <motion.div
                    ...
                    <Image src='/assets/anotherway.png' alt='anotherway image' width={1000} height={1000} className='p-2 scale-75 md:scale-100 ' />
                </motion.div>
            </motion.div>
        </section>
    )
